// app/(pages)/(roles)/admin/groups/[groupId]/page.tsx
...
function StudentCard({
  ...
  return (
    <div className="flex items-center justify-between p-3 bg-[#f7fafa] rounded-lg border border-[#c0c8c9] hover:border-[#1a7a8a] transition-colors">
...
export default function GroupDetailsPage() {
  ...
  // جلب بيانات الطالب الحالي للمشرف
  ...
  // ✅ التحقق من صلاحية المعلم (إذا كان معلم، يجب أن يكون منشئ المجموعة)
  const canEdit = currentUser?.role === "admin" || currentUser?._id === group.createdBy;
    ...
    <div className="container mx-auto p-4 md:p-6 space-y-6" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-1">
            <span className="text-sm text-gray-500">{group.nameEn}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 flex justify-between items-center">
            <div>
              <p className="text-sm text-gray-500">السعة القصوى</p>
              <p className="text-2xl font-bold">{group.maxStudents}</p>
            </div>
          ...
          <CardContent className="p-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-green-500">
                {group.maxStudents - group.students.length}
              </p>
            </div>
            ...
            <div className="space-y-2">
              {group.students.map((student: any) => (
                <StudentCard
                  ...
                  isRemoving={isRemoving === student._id}
                />
              ))}
            </div>
          )}
        ...
        <DialogContent className="max-w-md" dir="rtl">
          <DialogHeader>
            ...
            <p className="text-sm text-gray-500">
              اختر طالباً من قائمة الطلاب المتاحين
            </p>
          </DialogHeader>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400">
                    {searchQuery
                      ...
                      : "جميع الطلاب في هذا الصف مسجلون في المجموعة"}
                  </p>
                </div>
              ) : (
