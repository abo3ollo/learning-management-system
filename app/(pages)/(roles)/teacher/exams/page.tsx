...
export default function TeacherExamsPage() {
  ...
  // الحصول على المواد الفريدة من الامتحانات
  const uniqueSubjects = exams 
    ? [...new Set(exams.map((e: any) => e.subject).filter(Boolean))]
    : [];
            ...
            <table className="w-full">
              <thead className="bg-[#f7fafa] border-b border-[#c0c8c9]">
                <tr>
                  ...
                  <th className="text-right px-4 py-3 text-xs font-semibold text-gray-500">المدة</th>
                  ...
                  <tr>
                    <td colSpan={8} className="px-6 py-16 text-center">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-sm text-gray-400">قم بإنشاء أول امتحان لك</p>
                        <Button 
                          variant="outline" 
                          size="sm" 
                          onClick={() => {
                  ...
                  exams?.map((exam: any, index: number) => {
                    ...
                    return (
                      <tr key={exam._id} className="hover:bg-[#f7fafa] transition-colors">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-500">{exam.duration} د</td>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex gap-1.5">
                            ...
                            {/* تصحيح - الذهاب لصفحة التصحيح */}
                            <Link href={`/teacher/exams/${exam._id}/grade`}>
                              <button 
                                className="p-1.5 hover:bg-purple-50 rounded-lg transition-colors" 
                                title="تصحيح الامتحان"
                              >
                                <CheckCircle className="h-4 w-4 text-gray-400 hover:text-purple-600" />
                              </button>
                            </Link>
