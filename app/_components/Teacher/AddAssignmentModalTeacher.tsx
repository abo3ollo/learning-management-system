// app/_components/Assignment/AddAssignmentModalTeacher.tsx
...
export function AddAssignmentModalTeacher({ isOpen, onClose, editAssignmentId }: AddAssignmentModalProps) {
  // ✅ جلب مجموعات المعلم فقط
  ...
  const [formData, setFormData] = useState({
    title: "",
    description: "",
    groupIds: [] as string[], // ✅ فقط المجموعات (بدون gradeId)
    type: "assignment",
    maxAttempts: "",
  ...
  const handleSubmit = async (status: "draft" | "published") => {
    ...
    try {
      ...
      const data = {
        ...
        gradeId: gradeId as any, // ✅ من المجموعة المختارة
